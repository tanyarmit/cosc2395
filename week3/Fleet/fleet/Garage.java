...
public class Garage {
    public static void main(String[] args) {
        ...
        int counter = 0;
        while (moreEntries) {
            System.err.println("Enter the make of the car: ");
            String make = input.nextLine();
            System.err.println("Enter the model of the car: ");
            String model = input.nextLine();
            System.err.println("Enter the year of the car: ");
            int year = input.nextInt();
            input.nextLine();
            System.err.println("Enter the engine size of the car: ");
            double engineSize = input.nextDouble();
            input.nextLine();
            Car car = new Car(make, model, year, engineSize);
            fleet[counter] = car;
            counter++;
            System.err.println("Do you want to enter more cars? (yes/no)");
